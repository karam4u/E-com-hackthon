...
const Page = () => {
  const [mainImage, setMainImage] = useState("/prod1.webp");
    ...
    <div className="bg-gray-100">
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="flex items-center mb-6">
          ...
          <h2 className="text-gray-800 font-semibold">Gaming Table</h2>
        </div>
        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full md:w-1/2 px-4 mb-8">
            ...
            <div className="flex gap-4 py-4 justify-center overflow-x-auto">
              {["/gaming1.jfif", "/gaming2.jfif", "/pc3.jfif"].map((image, index) => (
          ...
          <div className="w-full md:w-1/2 px-4">
            <h2 className="text-3xl font-bold mb-2">Gaming Table</h2>
            ...
            <div className="flex items-center space-x-4 mb-6">
              ...
              <button className="flex gap-2 items-center bg-black  text-white px-6 py-2 rounded-lg duration-300 border-2 border-black hover:bg-white hover:text-black">
                Add to Cart
              </button>
            </div>
            ...
            <section className="flex items-center">
              <h3 className="text-2xl font-medium mr-4">Share:</h3>
      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="flex flex-wrap -mx-4 justify-center">
          {[
            { id: 1, title: "Nordic Chair", price: "$399.99", image: "/gaming1.jfif" },
            { id: 2, title: "Ergonomic Chair", price: "$299.99", image: "/gaming2.jfif" },
